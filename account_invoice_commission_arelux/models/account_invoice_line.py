...
class AccountInvoiceLine(models.Model):
    ...
    def define_account_invoice_line_header_info_commission(self):
        res = super(AccountInvoiceLine, self).define_account_invoice_line_header_info_commission()
        res['ar_qt_activity_type'] = _('Activity type')
        return res

    @api.multi
    def define_account_invoice_line_info_commission(self):
        res = super(AccountInvoiceLine, self).define_account_invoice_line_info_commission()
        for item in self:
