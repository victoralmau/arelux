...
class MaintenanceInstallation(models.Model):
    ...
    @api.multi    
    def cron_autongenerate_maintenance_installation_next_month(self, cr=None, uid=False, context=None):
    ...
    @api.multi
    def cron_autongenerate_maintenance_installation_all_this_year(self, cr=None, uid=False, context=None):
        current_date = datetime.today()
