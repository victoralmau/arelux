...
class SaleOrder(models.Model):
    ...
    @api.multi    
    def cron_automation_todocesped_particular_sale_orders(self, cr=None, uid=False, context=None):
        current_date = datetime.now(pytz.timezone('Europe/Madrid'))
        #skip_cron
        skip_cron = True
        ...
        if skip_cron==False:
            ...
            if len(sale_order_ids)>0:
                ...
                next_activity_id_date_action = current_date + relativedelta(days=3)
                ...
                for sale_order_id in sale_order_ids:
                    ...
                    #next_activity_id
                    if sale_order_id.opportunity_id.lead_m2>=20 and sale_order_id.opportunity_id.lead_m2<=30:
                        sale_order_params['next_activity'] = True
                        sale_order_params['next_activity_id'] = 2
                        sale_order_params['next_activity_date_action'] = next_activity_id_date_action
                        sale_order_params['next_activity_title_action'] = '1 Llamada al cliente'
                    #Fix 15m
    ...
    @api.multi    
    def cron_automation_todocesped_particular_sale_orders_mail2(self, cr=None, uid=False, context=None):
        current_date = datetime.now(pytz.timezone('Europe/Madrid'))
        #skip_cron
        skip_cron = True
    ...
    @api.multi    
    def cron_automation_todocesped_particular_repaso_mail(self, cr=None, uid=False, context=None):
